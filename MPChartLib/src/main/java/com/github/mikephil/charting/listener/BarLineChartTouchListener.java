...
//dg start
                ...
                Log.v("OnTouchListener", "time=="+event.getEventTime());
                if(!isLongClickModule) {
                    isLongClickModule = isLongPressed(xDown, yDown, event.getX(),
                            event.getY(),event.getDownTime() ,event.getEventTime(),500);
                }
...
//                    Log.v("OnTouchListener", "longPress");
                }else {
//dg end
                if (mTouchMode == DRAG) {
                    mChart.disableScroll();
...
//                    if (mChart.isHighlightPerDragEnabled())
//                        performHighlightDrag(event);
//                    Log.v("OnTouchListener", "scroll_1");
                } else if (mTouchMode == X_ZOOM || mTouchMode == Y_ZOOM || mTouchMode == PINCH_ZOOM) {
//                    Log.v("OnTouchListener", "scroll_2");
                    mChart.disableScroll();
...
//                    Log.v("OnTouchListener", "scroll_3");
                    if (mChart.hasNoDragOffset()) {
//                        Log.v("OnTouchListener", "scroll_31");
                        if (!mChart.isFullyZoomedOut() && mChart.isDragEnabled()) {
//                            Log.v("OnTouchListener", "scroll_311");
                            mTouchMode = DRAG;
                        } else {
//                            Log.v("OnTouchListener", "scroll_312");
                            mLastGesture = ChartGesture.DRAG;
...
//                        Log.v("OnTouchListener", "scroll_32");
                        mLastGesture = ChartGesture.DRAG;
                        mTouchMode = DRAG;
                    }
                }
