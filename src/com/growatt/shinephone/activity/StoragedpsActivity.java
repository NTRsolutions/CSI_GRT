...
public class StoragedpsActivity extends DemoBase implements View.OnTouchListener ,GestureDetector.OnGestureListener{
	...
	private String id;
	private TextView Pv;
	private int[]list1={R.string.storagedps_list1_item1,R.string.storagedps_list1_item2,R.string.storagedps_list1_item3
			,R.string.storagedps_list1_item4,R.string.storagedps_list1_item5,R.string.storagedps_list1_item6,R.string.storagedps_list1_item7};
...
//		initLineChart();
	...
	private void SetViews() {
		...
		url=new Urlsutil().storageAgetgetDls+"&id="+id+"&date="+timemap.get("year")+"-"+timemap.get("month")+"-"+timemap.get("day")+"&type=1";
		addLineChart();
		setLineChart(url);
	}
		...
		GetUtil.get(url, new GetListener() {
			...
			public void success(String json) {
				try {
					...
					MyUtils.setLineChartData(StoragedpsActivity.this,lineChart,dataListLine,new int[]{R.color.chart_green_click_line},new int[]{R.color.chart_green_normal_line},1,R.color.note_bg_white);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		GetUtil.get(url, new GetListener() {
			...
			public void success(String json) {
				try {
					...
					MyUtils.setBarChartData(StoragedpsActivity.this,barChart,dataList,new int[]{R.color.chart_green_normal},new int[]{R.color.chart_green_click},1);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
...
//				}
	...
	public void showPopupWindow(final View views,final int[]list) {
		...
		InverterDpsSpinnerAdapter adapter = new InverterDpsSpinnerAdapter(StoragedpsActivity.this, list);
				...
				case 1:
					...
					switch (type) {
						...
						case 2:
							...
							break;
						case 3:
							power_units.setText(R.string.all_power_v);

							break;
						case 4:
							power_units.setText(R.string.all_power_a);
							break;
						case 5:
							power_units.setText(R.string.all_power_w);
							break;
						case 6:
							...
							break;
						case 7:
							power_units.setText(R.string.storage_percent);
							break;
					}
					setLineChart(url);
					getLong();
...
//        tvDate.setText(year_c + "年" + month_c + "月" + day_c + "日");
		...
		minScroll = MyControl.dip2px(StoragedpsActivity.this,100f);
	...
	private void addGridView() {
		...
		gridView.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				return StoragedpsActivity.this.gestureDetector.onTouchEvent(event);
			}
		});
/**
 * 加载数据
 */
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				setDate(position);
				//判断是否是未来数据
				if (MyUtils.isFutureTime(StoragedpsActivity.this,tvDate.getText().toString())) return;
				//重新加载数据
				refreshData();
			}
	...
	private void refreshData() {
		url=new Urlsutil().storageAgetgetDls+"&id="+id+"&date="+tvDate.getText().toString()+"&type="+1;
...
//						if (entry.getX() < 0.0001) continue;
					...
					if (mAdapter.isEmpty()){
						mListView.setOnTouchListener(StoragedpsActivity.this);
					}else {
						mListView.setOnTouchListener(new View.OnTouchListener() {
							@Override
