...
//                }
    ...
    private void matchUserPwd(final String pwd, final int position) {
        final EditText et= new EditText(OssStorageSpf5kSetActivity.this);
        et.setTransformationMethod(PasswordTransformationMethod.getInstance());
        AlertDialog dialog = new AlertDialog.Builder(OssStorageSpf5kSetActivity.this).setTitle(R.string.reminder)
                .setIcon(android.R.drawable.ic_menu_info_details).setMessage(R.string.inverterset_operate).setView(
                    ...
                    public void onClick(DialogInterface dialog, int swich) {
                        ...
                        if (s.equals(pwd)){
                            ...
                            MyControl.circlerDialog(OssStorageSpf5kSetActivity.this,getString(R.string.password_prompt),-1,false);
                        }
                    }
    ...
    private void setStorage(final int position) {
        ...
        switch (position){
            ...
            case 3://市电充电
                int type = 0;
                if (position == 2){ type = 2;}
                if (position == 3){ type = 3;}
    ...
    public void setSpf5kCircleDialog(Object items, String[] datas, final String[] paramName, final int position){
        new CircleDialog.Builder(OssStorageSpf5kSetActivity.this)
                .setTitle(datas[position])
                .setItems(items, new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
                        OssUtils.storageSetSPF5k(OssStorageSpf5kSetActivity.this, sn, paramName[position], pos + "","","","", new OnHandlerListener() {
                            @Override
                            public void handlerDeal(int result,String msg) {
                                OssUtils.showOssDialog(OssStorageSpf5kSetActivity.this,msg,result,true,null);
                            }
                        });
                    }
                })
