...
public class OssStorageDischargeTimeSetActivity extends DemoBase {
    ...
    private int type = 2;//由哪里跳转而来：2--oss强制放电时间段;3--oss强制充电时间段;4--server强制放电时间段;5--server强制充电时间段
    ...
    private void initView() {
        if (type == 3 || type == 5){
            MyUtils.showAllView(tvNote1,tvNote2);
        }else {
            MyUtils.hideAllView(View.GONE,tvNote1,tvNote2);
        }
    }
        ...
        new CircleDialog.Builder(this)
                ...
                .setPositive(getString(R.string.all_ok), new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        switch (type){
                            case 2:
                                ossStorageSetDisChargeTime(startTime,endTime);
                                break;
                            case 3:
                                ossStorageSetChargeTime(startTime,endTime);
                                break;
                            case 4:
                                serverStorageSetDisChargeTime(startTime,endTime);
                                break;
                            case 5:
                                serverStorageSetChargeTime(startTime,endTime);
                                break;
                        }
                    }
                })
...
//                handlerStorage.sendEmptyMessage(result);
                ...
                new TimePickerDialog(mContext,
                        ...
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                tvStartTime.setText((hourOfDay < 10 ? "0" + hourOfDay : hourOfDay)+ ":" + (minute < 10 ? "0" + minute :minute));
                            }
                        }
                        // 设置初始时间
            ...
            public void onClick(View v) {
                ...
                new TimePickerDialog(mContext,
                        ...
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                tvEndTime.setText((hourOfDay < 10 ? "0" + hourOfDay : hourOfDay)+ ":" + (minute < 10 ? "0" + minute :minute));
                            }
                        }
                        // 设置初始时间
                        , c.get(Calendar.HOUR_OF_DAY), c.get(Calendar.MINUTE),
    ...
    private Handler handlerStorage = new Handler(Looper.getMainLooper()){
        ...
        public void handleMessage(Message msg) {
            ...
            MyControl.circlerDialog(OssStorageDischargeTimeSetActivity.this,text,msg.what);
        }
    };
    //server储能机handler
