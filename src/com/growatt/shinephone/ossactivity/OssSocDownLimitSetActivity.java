 ...
 * 锂电池SOC下限设定
 */
@ContentView(R.layout.activity_oss_soc_down_limit_set)
public class OssSocDownLimitSetActivity extends DemoBase {
    ...
    private int type = 2;//由哪里跳转而来：2--oss储能机Soc下限设置;4--server储能机Soc下限设置
    @Override
...
//                handlerStorage.sendEmptyMessage(result);
    ...
    private Handler handlerStorage = new Handler(Looper.getMainLooper()){
        ...
        public void handleMessage(Message msg) {
            ...
            MyControl.circlerDialog(OssSocDownLimitSetActivity.this,text,msg.what);
        }
    };
    //server储能机handler
