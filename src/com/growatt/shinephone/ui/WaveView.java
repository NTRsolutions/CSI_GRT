...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#00ff0000");//����ɫ
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#00ff00ff");
