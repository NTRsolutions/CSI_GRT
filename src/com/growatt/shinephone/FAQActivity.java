...
public class FAQActivity extends DoActivity {
	...
	private void initData() {
		Mydialog.Show(this, "");
        GetUtil.get(new Urlsutil().getUsQuestionListByType+"&language="+getLanguage()+"&type=0", new GetListener() {
			@Override
	...
	private void initListView() {
		mRecyclerView=(RecyclerView) findViewById(R.id.listView_faq);
		mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
		mList=new ArrayList<Map<String, String>>();
		mAdapter=new MaintenanceV2Adapter(R.layout.item_faqactivity_listview, mList);
	...
	private void initListener() {
		mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
			...
			public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
				...
				Mydialog.Show(FAQActivity.this, "");
				GetUtil.get(new Urlsutil().getUsualQuestionInfo + "&id=" + item.get("id") + "&language=" + getLanguage(), new GetListener() {
					...
					public void success(String json) {
						...
						try {
							...
							Intent intent = new Intent(FAQActivity.this, CommondataActivity.class);
	...
	private void initView() {
		...
		header.setBackgroundColor(ContextCompat.getColor(this,R.color.gray));
		 setHeaderTitle(header, getString(R.string.InfoCenterAct_question), Position.LEFT);
		setHeaderImage(header, R.drawable.question_icon);
	}

	private void initHeaderView() {
		headerView=findViewById(R.id.headerView);
		setHeaderTitle(headerView, getString(R.string.InfoCenterAct_question));
