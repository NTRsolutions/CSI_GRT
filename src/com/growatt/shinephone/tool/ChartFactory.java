...
public class ChartFactory {
   ...
   *           series
   */
  public static final XYChart getLineChartIntent(Context context, XYMultipleSeriesDataset dataset,
   ...
   *           series
   */
  public static final XYChart getCubicLineChartIntent(Context context,
      XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, float smoothness) {
   ...
   *           series
   */
  public static final XYChart getScatterChartIntent(Context context,
      XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer) {
   ...
   *           series
   */
  public static final XYChart getBubbleChartIntent(Context context, XYMultipleSeriesDataset dataset,
      XYMultipleSeriesRenderer renderer) {
   ...
   *           series
   */
  public static final TimeChart getTimeChartIntent(Context context, XYMultipleSeriesDataset dataset,
   ...
   *           series
   */
  public static final BarChart getBarChartIntent(Context context, XYMultipleSeriesDataset dataset,
...
//    intent.putExtra(TITLE, activityTitle);
   ...
   *           series
   */
  public static final RangeBarChart getRangeBarChartIntent(Context context,
      XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, Type type,
      String activityTitle) {
    checkParameters(dataset, renderer);
//    Intent intent = new Intent(context, GraphicalActivity.class);
...
//    intent.putExtra(TITLE, activityTitle);
   ...
   *           series renderers or number of chart types
   */
  public static final CombinedXYChart getCombinedXYChartIntent(Context context,
      XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer, String[] types,
      String activityTitle) {
    if (dataset == null || renderer == null || types == null
        || dataset.getSeriesCount() != types.length) {
...
//    intent.putExtra(TITLE, activityTitle);
   ...
   *           series renderers
   */
  public static final PieChart getPieChartIntent(Context context, CategorySeries dataset,
...
//    intent.putExtra(TITLE, activityTitle);
   ...
   *           series renderers
   */
  public static final DoughnutChart getDoughnutChartIntent(Context context,
...
//    intent.putExtra(TITLE, activityTitle);
   ...
   *           series renderers
   */
  public static final DialChart getDialChartIntent(Context context, CategorySeries dataset,
