...
//		                Toast.makeText(x.app(), "cancelled", Toast.LENGTH_LONG).show();
	...
	//get 带参数
	public static void getParams(final String url, final postListener httpListener){
...
//	                Toast.makeText(x.app(), "cancelled", Toast.LENGTH_LONG).show();
	...
	public static void getParamsServerUrl(final String url, final postListener httpListener){
		final Map<String, String> params=new HashMap<String, String>();
		httpListener.Params(params);
		final Handler handler=new Handler(){
			@Override
