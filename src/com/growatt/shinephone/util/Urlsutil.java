...
//	public static String url_host ="server.growatt.com";//注册时用
	//	public  String serverurl="http://192.168.3.35:8081";
...
//public  static String serverurl="http://202.105.137.94";
...
//	public  String serverurl="http://120.76.153.241:8080/ShineServer_2016";
//	public  static String serverurl="http://192.168.3.214/ShineServer_2016";
...
//	public  static String serverurl="http://47.91.176.158";
...
////	public  String getImageDetialInfo="http://cdn.growatt.com/onlineservice/"+SqliteUtil.inquirylogin().get("name")+"/";
	...
	//电站图片
	public  String getPlantImageInfo="http://cdn.growatt.com/plantimg/";
	//添加电站
 ...
 */
	...
	//设置JLINV参数
	public  String postInverterSet_jlinv = GetUrl()+"/newAPIjlTcpSet.do?op=jlInvSetAPP";
	//	修改JLINV信息
